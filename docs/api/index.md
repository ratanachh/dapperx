...
This section is generated from the XML doc comments in the `DapperX` library and covers the public
surface consumers use directly: the [`IRepository<T, TId>`](xref:DapperX.Abstractions.Repositories.IRepository`2)
contract, the fluent [`IQuery<T>`](xref:DapperX.Abstractions.Query.IQuery`1) API, paging/sorting types,
