...
internal static class ExecutionPlanEmitter
{
    ...
    {
        sb.AppendLine($"    private static readonly global::Dapper.Npa.Batching.Execution.ExecutionPlan {plan.PlanName} = new()");
        sb.AppendLine("    {");
        sb.AppendLine("        Nodes = new global::Dapper.Npa.Batching.Execution.ExecutionNode[]");
        sb.AppendLine("        {");

        foreach (var node in plan.Nodes)
        {
            sb.Append("            new global::Dapper.Npa.Batching.Execution.ExecutionNode { ");
