...
internal static class BulkInsertGenerator
{
    ...
    public static string GetExecutorTypeName(string provider)
        => provider switch
        {
            "SqlServer" => "global::Dapper.Npa.Provider.SqlServer.SqlServerBulkExecutor",
            "PostgreSql" => "global::Dapper.Npa.Provider.PostgreSql.PostgreSqlBulkExecutor",
            "MySql" => "global::Dapper.Npa.Provider.MySql.MySqlBatchExecutor",
            _ => string.Empty,
        };
