        ...
        SourceProductionContext ctx)
    {
        ...
        catch (CpqlParseException ex)
        {
            ctx.ReportDiagnostic(Diagnostic.Create(
                new DiagnosticDescriptor("DPXCPQL001", "CPQL parse error", ex.Message, "Dapper.Npa.CPQL",
        ...
        {
            ctx.ReportDiagnostic(Diagnostic.Create(
                new DiagnosticDescriptor("DPXCPQL020", "CPQL translation error", ex.Message, "Dapper.Npa.CPQL",
                    DiagnosticSeverity.Error, true), location));
            return null;
        }
