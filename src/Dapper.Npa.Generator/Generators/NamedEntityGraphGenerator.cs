...
internal static class NamedEntityGraphGenerator
{
    ...
    private static void EmitGraphSqlSwitch(StringBuilder sb, IReadOnlyList<NamedEntityGraphModel> graphs)
    {
        ...
        sb.AppendLine("        _ => throw new Dapper.Npa.Abstractions.Graphs.InvalidEntityGraphException(entityGraph ?? string.Empty),");
        sb.AppendLine("    };");
        sb.AppendLine();
    }
    ...
    private static void EmitGraphFromSqlSwitch(StringBuilder sb, IReadOnlyList<NamedEntityGraphModel> graphs)
    {
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        null => throw new Dapper.Npa.Abstractions.Graphs.InvalidEntityGraphException(string.Empty),");
        foreach (var graph in graphs)
