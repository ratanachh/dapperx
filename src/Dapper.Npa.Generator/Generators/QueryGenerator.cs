...
internal static class QueryGenerator
{
        ...
        SourceProductionContext spc)
    {
        ...
        sb.AppendLine("    {");
        sb.AppendLine($"        var config = new Dapper.Npa.Runtime.Query.QueryRuntimeConfig");
        sb.AppendLine("        {");
        ...
        sb.AppendLine("        };");
        sb.AppendLine($"        return new Dapper.Npa.Runtime.Query.RepositoryQuery<{entity.FullyQualifiedName}>(");
