...
public class CompositeKeyGenerationTests
{
    ...
    {
        var source = ReadGenerated("CompositeOrderItemRepositoryImpl.g.cs");
        Assert.Contains("GetByIdAsync(global::Dapper.Npa.Tests.Fixtures.CompositeOrderItemId id", source);
    ...
    {
        var source = ReadGenerated("CompositeOrderItemRepositoryImpl.g.cs");
        Assert.Contains("DapperXRepositoryBase<Dapper.Npa.Tests.Fixtures.CompositeOrderItem, global::Dapper.Npa.Tests.Fixtures.CompositeOrderItemId>", source);
    }
}
