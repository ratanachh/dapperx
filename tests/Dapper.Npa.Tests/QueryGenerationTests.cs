...
public class QueryGenerationTests
{
    ...
    public void QueryExecutor_IncludeDeleted_omits_soft_delete_predicate()
    {
        ...
        var defaultState = QueryBuilderStateSnapshot.From(new Dapper.Npa.Query.Query.QueryBuilder<ArchivedItem>().Build());
        ...
        var includeDeleted = QueryBuilderStateSnapshot.From(
            new Dapper.Npa.Query.Query.QueryBuilder<ArchivedItem>().IncludeDeleted().Build());
    ...
    public void RepositoryQuery_Select_carries_entity_where_state_to_projection_sql()
    {
        ...
        var carried = QueryBuilderStateSnapshot.From(
            new Dapper.Npa.Query.Query.QueryBuilder<Product>().Where(p => p.Name == "x").Build());
    ...
    {
        var carried = QueryBuilderStateSnapshot.From(new Dapper.Npa.Query.Query.QueryBuilder<Product>().AsSlice().Build());
        var merged = carried.MergeWith(QueryBuilderStateSnapshot.From(new Dapper.Npa.Query.Query.QueryBuilder<Product>().Skip(2).Take(11).Build()));
