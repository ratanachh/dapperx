...
public class IntegAdvancedFeaturesTests
{
    ...
    public async Task PrimaryKeyJoinColumn_shares_profile_id()
    {
        ...
        var profileRepo = new global::DapperX.IntegrationTests.Shared.Fixtures.Generated.IntegUserProfileRepositoryImpl(env.Connection, env.Options);
    ...
    public async Task LazyMap_loads_employees_by_code()
    {
        ...
        var empRepo = new global::DapperX.IntegrationTests.Shared.Fixtures.Generated.IntegEmployeeRepositoryImpl(env.Connection, env.Options);
    ...
    public async Task Named_entity_graph_loads_order_lines()
    {
        ...
        var lineRepo = new global::DapperX.IntegrationTests.Shared.Fixtures.Generated.IntegGraphOrderLineRepositoryImpl(env.Connection, env.Options);
