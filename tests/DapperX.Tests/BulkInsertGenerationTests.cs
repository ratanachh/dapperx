...
public class BulkInsertGenerationTests
{
    ...
    {
        Assert.True(DapperX.Provider.Common.DatabaseProviderFactory.SupportsBulkInsert("SqlServer"));
        Assert.True(DapperX.Provider.Common.DatabaseProviderFactory.SupportsBulkInsert("PostgreSql"));
        Assert.True(DapperX.Provider.Common.DatabaseProviderFactory.SupportsBulkInsert("MySql"));
        Assert.False(DapperX.Provider.Common.DatabaseProviderFactory.SupportsBulkInsert("Sqlite"));
    }

    [Fact]
    public void SqlServerProvider_exposes_bulk_executor()
    {
        var provider = new DapperX.Provider.SqlServer.SqlServerProvider();
    ...
    {
        var provider = new DapperX.Provider.Sqlite.SqliteProvider();
