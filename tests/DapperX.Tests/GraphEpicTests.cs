...
public class GraphEpicTests
{
    ...
    public void OrderRepositoryImpl_delete_graph_closes_order_gaps_before_child_delete()
    {
        ...
        var deleteEnd = source.IndexOf("private static readonly global::DapperX.Batching.Execution.ExecutionPlan DeleteGraphExecutionPlan", deleteStart, StringComparison.Ordinal);
