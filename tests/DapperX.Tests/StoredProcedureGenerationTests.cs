...
public class StoredProcedureGenerationTests
{
    ...
    public void ProcOrderRepositoryImpl_basic_sp_emits_exec_and_query_async()
    {
        ...
        Assert.Contains("QueryAsync<DapperX.Tests.Fixtures.ProcOrder>", source);
    ...
    public void ProcOrderRepositoryImpl_multi_result_emits_query_multiple()
    {
        ...
        Assert.Contains("MultiResult<DapperX.Tests.Fixtures.ProcOrderSummary, DapperX.Tests.Fixtures.ProcOrderLine>", source);
        Assert.Contains("ReadAsync<DapperX.Tests.Fixtures.ProcOrderSummary>", source);
        Assert.Contains("ReadAsync<DapperX.Tests.Fixtures.ProcOrderLine>", source);
    }
